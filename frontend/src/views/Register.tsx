      ...
      <div className="relative hidden overflow-hidden bg-ink lg:flex lg:flex-col lg:justify-between lg:p-10">
        ...
        <div className="relative">
          <p className="max-w-md text-white/70">
            Crea tu cuenta de egresado para registrar tu práctica profesional.
          </p>
          <p className="mt-6 font-mono text-xs uppercase tracking-wide text-white/50">
            Colegio técnico · Registro de egresado
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center bg-paper p-6 lg:p-12">
        <div className="w-full max-w-md space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted">Regístrate como estudiante para comenzar.</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <Field label="Carrera / especialidad" htmlFor="major" hint="Opcional. Ej.: Telecomunicaciones.">
              <Input
                id="major"
                value={major}
